...
<form name="formEdit" id="formEdit" method="post" action="<?php echo DIRPAGE.'controllers/ControllerEdit.php'; ?>">
        ...
        Aluno: <input type="text" name="title" id="title" value="<?php echo $events['title']; ?>"><br>
        Treino: <input type="text" name="description" id="description" value="<?php echo $events['description']; ?>"><br>
